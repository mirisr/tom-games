...
def run_inference_PO_path_conditioned(locs, poly_map, isovist):
	...
	post_sample_traces = run_inference_MH(Q, post_samples=5, samples=200)
	...
	close_plot(fig, ax, plot_name="PO_forward_runs/conditioned-1/MH_hear_run_and_catch-5-200"+str(int(time.time()))+".eps")
