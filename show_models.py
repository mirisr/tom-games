...
def simulate_running_goal_inference(Q, poly_map, locs):
	x1,y1,x2,y2 = poly_map
	# plan for the runner
	start = 4
	goal = 0
	path = planner.run_rrt_opt( np.atleast_2d(locs[start]), 
...
if __name__ == '__main__':
	...
	Q = p.ProgramTrace(runner_model)

	simulate_running_goal_inference(Q, poly_map, locs)
